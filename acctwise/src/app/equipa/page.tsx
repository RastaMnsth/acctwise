  ...
  return (
    <main className="pt-20">
      ...
      <CTASection 
        ...
        subtitle="Estamos sempre à procura de talentos apaixonados por contabilidade e finanças para se juntarem à nossa equipa. Se está interessado em trabalhar connosco, entre em contacto."
