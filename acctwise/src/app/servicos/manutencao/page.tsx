...
export default function ManutencaoPage() {
  return (
    <main className="pt-20">
      ...
      <CTASection 
        title="Pronto para Otimizar os Seus Sistemas?"
        subtitle="Deixe-nos cuidar da manutenção para que possa focar-se no que realmente importa: fazer crescer o seu negócio."
        buttonText="Agende uma Avaliação Hoje"
        buttonLink="/contacto"
        variant="secondary"
      />
    </main>
